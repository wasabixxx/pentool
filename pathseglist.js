(function (t, e) {
    !(function () {
      ...
      "SVGPathSeg" in window ||
        ...
        (window.SVGPathSegCurvetoCubicAbs = function (t, e, i, n, r, s, a) {
          window.SVGPathSeg.call(this, window.SVGPathSeg.PATHSEG_CURVETO_CUBIC_ABS, "C", t), (this._x = e), (this._y = i), (this._x1 = n), (this._y1 = r), (this._x2 = s), (this._y2 = a);
        }),
        ...
        (window.SVGPathSegCurvetoCubicRel = function (t, e, i, n, r, s, a) {
          window.SVGPathSeg.call(this, window.SVGPathSeg.PATHSEG_CURVETO_CUBIC_REL, "c", t), (this._x = e), (this._y = i), (this._x1 = n), (this._y1 = r), (this._x2 = s), (this._y2 = a);
        }),
        ...
        (window.SVGPathSegArcAbs = function (t, e, i, n, r, s, a, o) {
          window.SVGPathSeg.call(this, window.SVGPathSeg.PATHSEG_ARC_ABS, "A", t), (this._x = e), (this._y = i), (this._r1 = n), (this._r2 = r), (this._angle = s), (this._largeArcFlag = a), (this._sweepFlag = o);
        }),
        ...
        (window.SVGPathSegArcRel = function (t, e, i, n, r, s, a, o) {
          window.SVGPathSeg.call(this, window.SVGPathSeg.PATHSEG_ARC_REL, "a", t), (this._x = e), (this._y = i), (this._r1 = n), (this._r2 = r), (this._angle = s), (this._largeArcFlag = a), (this._sweepFlag = o);
        }),
        ...
        (window.SVGPathElement.prototype.createSVGPathSegCurvetoCubicAbs = function (t, e, i, n, r, s) {
          return new window.SVGPathSegCurvetoCubicAbs(void 0, t, e, i, n, r, s);
        }),
        (window.SVGPathElement.prototype.createSVGPathSegCurvetoCubicRel = function (t, e, i, n, r, s) {
          return new window.SVGPathSegCurvetoCubicRel(void 0, t, e, i, n, r, s);
        }),
        ...
        (window.SVGPathElement.prototype.createSVGPathSegArcAbs = function (t, e, i, n, r, s, a) {
          return new window.SVGPathSegArcAbs(void 0, t, e, i, n, r, s, a);
        }),
        (window.SVGPathElement.prototype.createSVGPathSegArcRel = function (t, e, i, n, r, s, a) {
          return new window.SVGPathSegArcRel(void 0, t, e, i, n, r, s, a);
        }),
            ...
            (n.prototype._isCurrentSpace = function () {
              ...
              (n.prototype._parseNumber = function () {
                ...
                if (
                  ...
                  if (this._currentIndex != o) for (var h = this._currentIndex - 1, l = 1; h >= o; ) (e += l * (this._string.charAt(h--) - "0")), (l *= 10);
                  ...
                  if (
                    ...
                    if (
                      (this._currentIndex++,
                      "+" == this._string.charAt(this._currentIndex) ? this._currentIndex++ : "-" == this._string.charAt(this._currentIndex) && (this._currentIndex++, (s = -1)),
                  ...
                  var u = e + n;
                  if (((u *= r), t && (u *= Math.pow(10, s * t)), a != this._currentIndex)) return this._skipOptionalSpacesOrDelimiter(), u;
                }
              }),
